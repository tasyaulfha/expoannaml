  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">LACAK [PELAPOR]</a>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Profil">
         ...
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Profil">
          <a class="nav-link" href="{{route('laporan')}}">
            ...
            <span class="nav-link-text">Laporkan</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Lihat Laporan">
          <a class="nav-link" href="{{route('laporanku.show')}}">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Lihat Laporanku</span>
          </a>
        </li>
      </ul>
